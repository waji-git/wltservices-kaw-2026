        ...
        <div className={`flex items-center space-x-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
          ...
          <button
            ...
            className={`transition-colors p-1.5 rounded-lg ${
              isDarkMode ? "text-yellow-400 hover:text-yellow-300 hover:bg-gray-800" : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
            }`}
          ...
          {/* Notification Icon */}
          <button className={`relative ${isDarkMode ? "hover:text-white" : "hover:text-gray-900"}`}>
          ...
          <div className="relative">
            <button
              ...
              className={`focus:outline-none flex items-center ${isDarkMode ? "hover:text-white" : "hover:text-gray-900"}`}
            >
              <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            {isDropdownOpen && (
              <>
                ...
                <div className={`absolute right-0 mt-2 w-44 rounded-lg border py-1.5 shadow-xl z-20 ${isDarkMode ? "bg-gray-900 border-gray-800 text-gray-200" : "bg-white border-gray-200 text-gray-700"}`}>
                  <button
                    onClick={() => { alert("Viewing details..."); setIsDropdownOpen(false); }}
                    className={`block w-full text-left px-4 py-2.5 text-sm font-medium transition-colors ${isDarkMode ? "hover:bg-gray-800 text-gray-300" : "hover:bg-gray-100 text-gray-700"}`}
                  >
                  ...
                  <hr className={`${isDarkMode ? "border-gray-800" : "border-gray-100"} my-1`} />
                  <button onClick={handleLogout} className="block w-full text-left px-4 py-2.5 text-sm font-semibold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors">
                    <div className="flex items-center gap-2">
              ...
              <li key={index} className="pb-3">
                <Link
                  ...
                  className={`transition-colors pb-3 block ${
                    isActive ? "border-b-2 border-blue-500 text-blue-600 font-bold" : isDarkMode ? "hover:text-gray-200" : "hover:text-blue-600"
                  }`}
                >
                  {tab.name}
                </Link>
