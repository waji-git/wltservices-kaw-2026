...
// import { User, LogOut, Briefcase, Calendar } from "lucide-react";
// import {
//   getAllLeaveRequests,
//   updateLeaveApproval,
//    getAllMovementRequests, // Ensure this is commented out or removed if not exported
...
//     let res;
//     if (activeTab === "leave") {
//       res = await getAllLeaveRequests();
//     } else {
//       res = { success: false, error: "getAllMovementRequests is not implemented" }; // Replace with appropriate logic or remove
//     }

//     if (res.success && res.data) {
//       setRequests(res.data);
//     } else {
//       alert(`Error loading ${activeTab} requests: ${res.error}`);
//     }
//   }, [activeTab]);
...
//     let res;
//     if (activeTab === "leave") {
//       res = await updateLeaveApproval(selectedRow._id, actionType);
//     } else {
//       res = await updateMovementApproval(selectedRow._id, actionType);
//     }
...
//               Confirm {activeTab.toUpperCase()} Request Action
//             </h3>
...
export default function AdminApprovalPage() {
  ...
  const handleStatusChange = async () => {
    ...
    if (activeTab === "leave") {
      ...
      res = await updateMovementApproval(
        selectedRow._id,
        actionType,
        currentUser._id
      );
